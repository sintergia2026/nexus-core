...
import { computeCrcpDecision } from "../05_engine/intake/crcp/crcp_decision_engine";
import { buildCrcpDiagnosticSnapshot } from "../05_engine/intake/crcp/crcp_snapshot_builder";
import { buildCrcpTwinSeed } from "../05_engine/intake/crcp/crcp_twin_seed_builder";
...
function main(): void {
  ...
  const snapshot = buildCrcpDiagnosticSnapshot(samplePayload, scores, decision);
  const twinSeed = buildCrcpTwinSeed(snapshot);

  console.log("==================================================");
  console.log("CRCP TWIN SEED CHECK");
  console.log("==================================================");
  console.log(JSON.stringify(twinSeed, null, 2));
  console.log("==================================================");
}
